...
Version: 16.0 - HYBRID ENTERPRISE ORCHESTRATOR
Preserves all original attributes while adding enterprise response handling.
...
CHANGES FROM VERSION 15.0:
- Added _extract_whatsapp_message() for robust response extraction
- Added response validation to ensure non-empty responses
- Added detailed logging with response preview
...
# =====================================================================================================================
# NEW: Response Extraction Helper (Added from Enterprise Version)
# =====================================================================================================================
...
class AIProviderService:
    ...
    # =====================================================================================================================
    # UPDATED: process_whatsapp_query with enterprise response extraction
    # =====================================================================================================================
