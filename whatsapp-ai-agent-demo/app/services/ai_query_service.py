# ==========================================================
# FILE: app/services/ai_query_service.py (ENTERPRISE v25.0)
# ==========================================================
...
# - Routes to intent_engine, entity_extractor, context_service
# - Forwards to query_router_service for service dispatch
# - Circuit breaker, deduplication, response validation
# ==========================================================
...
# ==========================================================
# SERVICE IMPORTS (Aligned with architecture)
# ==========================================================
...
class AIQueryService:
    """
    Enterprise AI Query Service - Master Orchestrator v25.0
    ...
    WhatsApp User → webhook.py → whatsapp_service.py → THIS FILE
                                    ...
                                    │                         │                         │
                                    ▼                         ▼                         ▼
                            intent_engine.py          entity_extractor.py      context_service.py
                                    │                         │                         │
                                    └─────────────────────────┼─────────────────────────┘
                                                              │
                                                              ▼
                    ...
                    │             │             │             │             │             │             │
                    ▼             ▼             ▼             ▼             ▼             ▼             ▼
            logistics_      analytics_      kpi_        forecasting_   recommendation_  control_tower_  groq_insight_
            query_service   service         service     service         service         service         service
                    │             │             │             │             │             │             │
                    └─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┘
                                                              │
                                                              ▼
    ...
    def __init__(self, db: Session):
        ...
        # Initialize core services (aligned with architecture)
        ...
        logger.info("=" * 70)
        logger.info("🚀 AI QUERY ORCHESTRATOR v25.0 - ENTERPRISE READY")
...
Please try again in a few moments."""
    ...
    def process_query(
        ...
        FLOW:
        1. Load context (context_service.py)
        2. Extract entities (entity_extractor.py)
        3. Detect intent (intent_engine.py)
        4. Route to service (query_router_service.py)
        5. Generate response (report_generator_service.py)
        ...
        try:
            # ==========================================================
            # STEP 1: Load Context (context_service.py)
            # ==========================================================
            ...
            # ==========================================================
            # STEP 2: Extract Entities (entity_extractor.py)
            # ==========================================================
            ...
            # ==========================================================
            # STEP 3: Detect Intent (intent_engine.py)
            # ==========================================================
            ...
            # ==========================================================
            # STEP 5: Route to Service (query_router_service.py)
            # ==========================================================
            ...
            # Route with retry (forwards to appropriate service)
            ...
            # ==========================================================
            # STEP 6: Generate Response (report_generator_service.py)
            # ==========================================================
            ...
            # Try circuit breaker protected fallback (groq_insight_service.py)
...
def health_check(db: Session) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "circuit_breaker": service.circuit_breaker.get_state(),
