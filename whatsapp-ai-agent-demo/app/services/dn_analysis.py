...
# ==========================================================
# PURPOSE: Enterprise DN Analytics Engine - Haier Pakistan Logistics
# SOURCE: delivery_reports table ONLY (PostgreSQL Single Source of Truth)
# VERSION: 13.0 - ENTERPRISE PRODUCTION
#
...
#
# KEY FEATURES:
# - ✅ Production DN Search Engine (no more "not found" bugs)
# - ✅ Complete DN information retrieval
# - ✅ Intelligent shipment stage from dates (not status columns)
# - ✅ Product analytics with material numbers
...
class DNAnalysisService:
    """Enterprise DN Analytics Service - Production Ready."""
    ...
    # ==========================================================
    # BLOCK 5: DN NORMALIZATION (CENTRALIZED)
    # ==========================================================
    ...
    def _normalize_dn(self, dn_no: str) -> str:
        ...
        - Hyphens, dots, slashes, underscores
    ...
    # ==========================================================
    # BLOCK 6: SQL QUERY BUILDERS (REUSABLE)
    # ==========================================================
    ...
    # ==========================================================
    # BLOCK 11: DN SEARCH ENGINE (PRODUCTION)
    # ==========================================================
    
    def search_dn(self, dn_no: str) -> Dict[str, Any]:
        """
        Production DN Search Engine.
        ...
        if similar_dns:
            ...
            # Step 5: Try exact match on each similar DN
            ...
            # Return similar DNs if none matched
            return {
                "success": False,
    ...
    def verify_dn(self, dn_no: str) -> Dict[str, Any]:
        """Verify if DN exists using the search engine."""
    ...
    def get_dn_dashboard(self, dn_no: str) -> Dict[str, Any]:
        ...
        # Get model details
        normalized_dn = self._normalize_dn(dn_no)
        model_results = self._execute_query(self._build_model_query(), {"dn_no": normalized_dn})
    ...
    def get_complete_dn_dashboard(self, dn_no: str) -> Dict[str, Any]:
        """Get complete DN dashboard with distance."""
        ...
        if warehouse and destination:
            ...
            data['eta'] = self.estimate_delivery_eta(distance_data.get('distance_km', 0))
            
            total_cycle_days = data.get('total_cycle_days', 0)
            expected_days = 1 if data['eta'] == "Same Day" else 2
            if total_cycle_days > 0:
                ...
                data['route_efficiency'] = self.calculate_route_efficiency(
                    distance_data.get('distance_km', 0), total_cycle_days, expected_days
                )
        
        return {"success": True, "data": data}
    
    # ==========================================================
    # BLOCK 14: DIAGNOSTIC METHODS
    # ==========================================================
    
    def diagnose_dn(self, dn_no: str) -> Dict[str, Any]:
        """Diagnose DN with full details."""
    ...
    def format_dn_dashboard(self, dashboard_data: Dict[str, Any]) -> str:
        ...
        if order_type:
            ...
            lines.append("{}".format(order_type))
            lines.append("")
        
        if storage_location:
            lines.append("*Storage:*")
            lines.append("{}".format(storage_location))
            lines.append("")
...
logger.info("=" * 70)
logger.info("DNAnalysisService v13.0 - ENTERPRISE PRODUCTION READY")
logger.info("=" * 70)
logger.info("")
...
logger.info("   ✅ Production DN Search Engine")
logger.info("   ✅ Intelligent status from dates")
logger.info("   ✅ Complete DN information retrieval")
logger.info("   ✅ Product analytics with material numbers")
