...
VERSION: v13.3 - COMPLETE DN INFORMATION AGGREGATOR
======================================================================================================
PURPOSE: Fetch ALL information for a DN and aggregate into single dashboard
======================================================================================================
import logging
...
"""
DN Analytics Service - Fetch ALL information for a DN and aggregate.
"""
...
📅 Dates:
DN Create: 2026-06-01
PGI: 2026-06-03
POD: 2026-06-10

⏳ Aging:
Delivery: 2 Days
POD: 7 Days (1-2 Weeks)
Total Cycle: 9 Days (1-2 Weeks)
...
Products - Show ALL products for the DN
...
======================================================================================================
logger.info("=" * 70)
logger.info("DNAnalysisService v13.3 - COMPLETE DN INFORMATION AGGREGATOR")
logger.info("=" * 70)
logger.info("")
logger.info(" SERVICE DETAILS:")
logger.info(" ✅ Service Name: dn_analysis")
logger.info(" ✅ Version: 13.3")
logger.info(" ✅ Source: PostgreSQL (delivery_reports)")
logger.info("")
logger.info(" FEATURES:")
logger.info(" ✅ Fetches ALL rows for a DN")
logger.info(" ✅ Aggregates ALL data into one dashboard")
logger.info(" ✅ Shows ALL products for the DN")
logger.info(" ✅ Calculates aging from dates")
logger.info(" ✅ Calculates status from dates")
