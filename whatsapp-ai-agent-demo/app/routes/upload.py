# ==========================================================
# FILE: app/routes/upload.py (v3.0 - ENTERPRISE PRODUCTION)
# ==========================================================
...
async def upload_excel(
    ...
    4. Deletes ALL existing delivery records
    ...
    try:
        ...
        # =============================================
        # STEP 8: Delete all existing records (with timeout monitoring)
        # =============================================
        with StepTimer("Delete records", request_id):
            ...
            try:
                ...
                if previous_count > 0:
                    ...
                    if lock_check.get('lock_count', 0) > 0:
                        logger.warning(f"[REQUEST_ID: {request_id}] Locks detected before delete, "
                                     f"may cause delay")
                ...
                if remaining > 0:
                    logger.warning(f"[REQUEST_ID: {request_id}] {remaining} records remain after deletion")
...
logger.info("=" * 60)
logger.info("📤 Upload Router v3.0 - ENTERPRISE PRODUCTION")
logger.info("=" * 60)
logger.info("")
...
logger.info("   ✅ Enhanced error logging with context")
